 ...
 Select tab.cod_bove, (Select
          ...
          tab.ind_acti
            From(
              ...
              tv.fec_proc_aper fec_gene, --Fecha de Generación --fecha de apertura boveda OA 23/07/2014
              csweb.fec_crea fec_env,--Fecha de Envío
              csweb.cod_seri_cmpb tipo_num_cs, -- Serie de CS
              csweb.num_cmpb num_cs, --Número CS
              (Select
              Case
              ...
              Case
                ...
                Else 0
              End result_set
              From dual) mont_fisi,--Monto Físico
              (Select
                Case
                  When csweb.tip_cmpb_safe  = 2 Then
                    Case
             ...
             (Select
                Case
                    When csweb.tip_cmpb_safe  = 2 Then
                     ...
                     Else Null
                     End result_set
                  From dual) ref_regu, --Referencia Regularización
             (Select
                Case
                    When csweb.tip_cmpb_safe  = 2 Then
                     ...
                     Else Null
                     End result_set
                  From dual) fec_regu, --Fecha de Regularización
             (Select
             Case
            ...
            Where csweb.cod_sucu_htb = 1
              ...
              --Consulta sólo para el rango de fechas contables ingresado PC 19/08/2014 REQ:2542 
